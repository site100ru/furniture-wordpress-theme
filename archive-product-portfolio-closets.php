...
<section class="archive-portfolio-section-2 pt-4 bg-white" style="padding-bottom: 60px;">
	<div class="container">
		...
		<div class="row text-md-center">
			<div class="col">
				<a href="/furniture/portfolio-cat/06-шкафы/" type="button" class="btn btn-lg btn-corporate-color-1">Показать
					еще</a>
			</div>
		</div>
	</div>
	...
	<div class="container py-5">
		<div class="row justify-content-center py-5">
			<div class="col-md-5 text-md-end">
				...
				<p class="section-description text-light mb-3">Хотите узнать стоимость качественного шкафа с учетом всех Ваших
					...
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-9 col-md-10">
								<h3 class="advantage-title text-start">Замер и дизайн-проект бесплатно</h3>
								<p class="text-start">При заключении договора наш специалист бесплатно сделает замер и разработает
									дизайн-проект Вашей будущего шкафа</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-9 col-md-10">
								...
								<p class="text-start">Мы обеспечиваем полный цикл изготовления шкафа (проект, производство, доставка,
