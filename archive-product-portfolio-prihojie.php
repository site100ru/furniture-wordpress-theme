	...
	<div class="container">
		...
		<div class="row">
			...
			while ($query->have_posts()):
				$query->the_post(); ?>
				<div class="col-md-6">
					<div id="carouselExampleIndicators<?php echo $post->ID; ?>" class="carousel slide mb-4" data-bs-ride="carousel"
									...
									<div class="carousel-item <?php if ($i == 1)
										...
										<a
											...
											<div class="single-product-img approximation">
												<img src="<?php echo get_post_meta($post->ID, '_img-' . $i)[0]; ?>" class="shadow rounded" alt="..."
													loading="lazy">
		...
		<div class="row text-md-center">
			<div class="col">
				<a href="/furniture/portfolio-cat/02-прихожие/" type="button" class="btn btn-lg btn-corporate-color-1">Показать
					еще</a>
			</div>
		</div>
	</div>
...
<section class="order-left-gradient-section">
	<div class="container py-5">
		<div class="row justify-content-center py-5">
			<div class="col-md-5 text-md-end">
				...
				<p class="section-description text-light mb-3">Хотите узнать стоимость качественной прихожей с учетом всех Ваших
					пожеланий и особенностей помещения? Это бесплатно и ни к чему Вас не обязывает!</p>
	...
	<img src="<?php echo get_template_directory_uri(); ?>/img/order-right-gradient-section-img.jpg"
	...
	<div class="container">
		...
		<div class="row justify-content-between about_box">
			...
			<div class="col-12 col-lg-5 offset-lg-1 order-1 order-lg-last mb-lg-0 description_about">
				<p class="text-start">Студия «Furniture» поможет каждому клиенту при выборе мебели по индивидуальным
					...
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-9 col-md-10">
								<h3 class="advantage-title text-start">Замер и дизайн-проект бесплатно</h3>
								<p class="text-start">При заключении договора наш специалист бесплатно сделает замер и разработает
									дизайн-проект Вашей будущей прихожей</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 mb-4">
						<div class="row">
							...
							<div class="col-9 col-md-10">
								...
								<p class="text-start">Мы обеспечиваем полный цикл изготовления прихожей (проект, производство, доставка,
	...
	<div class="container py-5">
		<div class="row justify-content-center py-5">
			...
			<div class="col-md-5">
				...
				<p class="section-description mb-3">Для расчета присылайте фото или видео с комментариями нам в мессенджер или
					через форму на сайте. Ответим на вопросы о покраске.</p>
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/section-title-dec.svg" class="mb-5">
				<br>
				<a href="#" type="button" class="btn btn-lg btn-corporate-color-1 mb-5" data-bs-toggle="modal"
					data-bs-target="#calculatePriceWithDownloadModal">Рассчитать стоимость</a>
				<div class="row">
					<div class="col">
						<ul class="nav">
