            ...
            <div class="container">
                ...
                <div class="d-lg-none">
                    ...
                    <div style="font-size: 10px; font-family: Gilroy-Light; text-transform: none;">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/ico/clock-ico.svg"
                            style="width: 12px; position: relative; top: -1px;" class="me-1">Пн-Сб: с 10.00-19.00<br>Вс:
                        с 10.00-17.00
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div style="position: relative">
                    <video id="video-player" class="rounded" style="width: 100%; max-height: 480px; overflow: hidden;"
                        ...
                        poster="<?php echo get_template_directory_uri(); ?>/img/cucina-video-poster.jpg">
    ...
    <div class="container">
        <div class="row">
            <div class="col text-md-center">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/img/ico/section-title-dec.svg" class=""
                    style="margin-bottom: 60px;">
            </div>
        </div>
        <!-- Слайдер Bootstrap -->
                    ...
                    <div class="carousel-inner rounded">
                        <div class="carousel-item active">
                            <a onClick="aboutSectionGallery1On('aboutSectionGallery1','imgAboutSectionGallery1-1');">
                                <div class="single-product-img approximation">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/card-image-cucina1.jpg"
                        ...
                        <div class="carousel-item">
                            <a onClick="aboutSectionGallery1On('aboutSectionGallery1','imgAboutSectionGallery1-2');">
                                <div class="single-product-img approximation">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/card-image-cucina2.jpg"
                                        class="d-block w-100" loading="lazy" alt="...">
                                    <div class="magnifier"></div>
                                </div>
                            </a>
