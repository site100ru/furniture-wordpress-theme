		...
		<div class="row">
			<div class="col">
				<div class="breadcrumbs py-4">
					<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/breadcrumbs-icon.svg"></a> / Католог / Шкафы</nav>
				</div>
			</div>
		</div>
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col text-md-center">
				...
				<div class="row">
					...
					<?php	
						...
						$args = [
							...
							'numberposts' 	 => 6,
							'posts_per_page' => 6,
							'portfolio-cat'  => '020-шкафы'//$portfolio_cat
						];
				...
				<a href="https://site100.ru/furniture/portfolio-cat/020-шкафы/" class="btn btn-lg btn-corporate-color-1" style="margin-top: 12px;">Смотреть еще</a>
			</div>
		</div>
	</div>
</section>
