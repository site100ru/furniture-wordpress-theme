...
<section class="archive-portfolio-section-2 pt-4 bg-white" style="padding-bottom: 60px;">
	<div class="container">
		...
		<div class="row text-md-center">
			<div class="col">
				<a href="/furniture/portfolio-cat/02-прихожие/" type="button" class="btn btn-lg btn-corporate-color-1">Показать еще</a>
			</div>
		</div>
	</div>
</section>				
	...
	<div class="container py-5">
		<div class="row justify-content-center py-5">
			<div class="col-md-5 text-md-end">
				...
				<p class="section-description text-light mb-3">Хотите узнать стоимость качественной прихожей с учетом всех Ваших пожеланий и особенностей помещения? Это бесплатно и ни к чему Вас не обязывает!</p>
