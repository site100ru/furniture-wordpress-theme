...
<section class="main-home-section min-home main-parallax main-home-section-kyxnu">
            ...
            <div class="col-md-6 mb-5">
                <a href="/furniture/product-category/кухни/">
                    <div class="approximation project-container-2 services">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-1.jpg" class="img-fluid"
                            alt="">
            ...
            <div class="col-md-6 mb-5">
                <a href="/furniture/product-category/шкафы/">
                    <div class="services approximation project-container-2">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/project-2.jpg" class="img-fluid"
                            alt="" decoding="async" />
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
        ...
        <div class="row text-start">
            <div class="col-md-6 mb-5">
                <a href="/furniture/кухни-на-заказ/">
                    <div class="approximation project-container-2 services">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/services-1.jpg" class="img-fluid"
                            alt="">
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
            ...
            <div class="col-md-6 mb-5">
                <a href="/furniture/шкафы-на-заказ/">
                    <div class="services approximation project-container-2">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/services-2.jpg" class="img-fluid"
                            alt="" decoding="async" />
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
