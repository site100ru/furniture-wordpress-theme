...
/**
 * Template Name: Главная паралакс
...
<section class="main-home-section main-parallax main-home-section-kyxnu">
	...
	<div class="container">
		<div class="row align-items-center home-section-height">
			<div class="col-xl-10 col-xxl-9">
				...
				<p class="home-subtitle mb-4">Изготовим качественный шкаф с учетом Ваших пожеланий и особенностей помещения.
			...
			<div class="col-md-6 mb-5">
				<a href="/furniture/product-category/кухни/">
					<div class="approximation project-container-2 services">
						<img src="<?php echo get_template_directory_uri(); ?>/img/project-1.jpg" class="img-fluid" alt="">
			...
			<div class="col-md-6 mb-5">
				<a href="/furniture/product-category/шкафы/">
					<div class="services approximation project-container-2">
						<img src="<?php echo get_template_directory_uri(); ?>/img/project-2.jpg" class="img-fluid" alt=""
							decoding="async" />
						<div class="card-wrapper project-container-2-footer">
							<div class="row" style="height: 100%;">
								<div class="col-6">
			...
			<div class="col text-md-center">
				...
				<ul class="nav nav-tabs justify-content-center mb-4" id="myTab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button"
							...
							Все
							<img class="ms-3" src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-decoration-point.svg"
								alt="">
						</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link ps-0" id="kitchens-tab" data-bs-toggle="tab" data-bs-target="#kitchens"
							type="button" role="tab" aria-controls="kitchens" aria-selected="false">
							Кухни
							<img class="ms-3" src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-decoration-point.svg"
								alt="">
						</button>
					...
					<li class="nav-item" role="presentation">
						<button class="nav-link ps-0" id="wardrobes-tab" data-bs-toggle="tab" data-bs-target="#wardrobes"
							type="button" role="tab" aria-controls="wardrobes" aria-selected="false">
							Шкафы
							<img class="ms-3" src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-decoration-point.svg"
								alt="">
						</button>
					...
					<li class="nav-item" role="presentation">
						<button class="nav-link ps-0" id="other-tab" data-bs-toggle="tab" data-bs-target="#other" type="button"
				...
				<div class="tab-content" id="portfolioTabContent">
					...
					<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
						...
						<a href="/furniture/portfolio/" class="btn btn-lg btn-corporate-color-1" style="margin-top: 12px;">Смотреть
							еще</a>
					</div>
		...
		<div class="row justify-content-center py-5">
			<div class="col-md-6 text-md-end">
				...
				<p class="order-description mb-3">
					Узнайте стоимость качественной кухни с учетом всех Ваших пожеланий и особенностей помещения. Оставьте заявку
					нажав на кнопку ниже или напишите нам в мессенджер.
					Это бесплатно и ни к чему Вас не обязывает!
				</p>

				<img src="<?php echo get_template_directory_uri(); ?>/img/ico/section-title-dec.svg" alt="Точки"
