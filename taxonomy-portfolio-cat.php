							...
							<ul class="nav justify-content-md-center d-flex m-auto">
								...
								<?php
									...
									foreach( $terms as $term ) { ?>
										<li class="nav-item d-none d-xl-inline"><span class="nav-link px-0"><img style="margin-bottom: 5px;" src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-decoration-point.svg" alt=""></span></li>
										<li class="nav-item">
