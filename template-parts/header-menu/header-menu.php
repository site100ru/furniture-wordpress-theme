        ...
        <div class="container">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item me-1 me-xxl-3">
                        <a class="nav-link" data-bs-toggle="modal" data-bs-target="#callbackModal">
                            <div class="d-flex align-items-center gap-2 lh-1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="svg-icon">
                                    <path
                    ...
                    <?php
                    /* Дополнительный телефон (раскомментируйте если нужен)
                    // Получаем дополнительный телефон
                    $phone_display_additional = '';
                    $phone_link_additional = '';
                    if (function_exists('mytheme_get_phone')) {
                        $phone_display_additional = mytheme_get_phone('additional');
                        $phone_link_additional = mytheme_get_phone_link('additional');
                    }
                    if (!empty($phone_display_additional)):
                    ?>
                    <li class="nav-item me-1 me-xxl-4">
                        <a class="top-menu-tel nav-link" href="tel:<?php echo esc_attr($phone_link_additional); ?>">
                            <div class="d-flex align-items-center gap-2 lh-1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="svg-icon">
                                    <path
                                        d="M4 3c0-1.655 1.305-3 2.91-3h10.18C18.696 0 20 1.345 20 3v18c0 1.655-1.305 3-2.91 3H6.91C5.304 24 4 22.655 4 21zm5.818 18c0 .413.328.75.728.75h2.909c.4 0 .727-.337.727-.75a.74.74 0 0 0-.728-.75h-2.908c-.4 0-.728.337-.728.75m7.273-18H6.909v15h10.182z" />
                                </svg>
                                <span><?php echo esc_html($phone_display_additional); ?></span>
                            </div>
                        </a>
                    </li>
                    <?php endif; */?>
...
<header id="sliding-header" class="shadow">
    ...
    <nav class="header-nav-bottom navbar navbar-expand-lg navbar-light py-1 py-lg-0">
        <div class="container">
            ...
            <div class="d-lg-none">
                <?php
                // Получаем основной телефон для sliding header
                $phone_display = '';
                $phone_link = '';
                if (function_exists('mytheme_get_phone')) {
                    $phone_display = mytheme_get_phone('main');
                ...
                if (!empty($phone_display)):
                ?>
                <a class="top-menu-tel" href="tel:<?php echo esc_attr($phone_link); ?>"><?php echo esc_html($phone_display); ?></a>
                <?php endif; ?>

                <?php
                // Получаем время работы для sliding header
                $job_time = '';
                if (function_exists('mytheme_get_job_time')) {
                    $job_time = mytheme_get_job_time();
                }
