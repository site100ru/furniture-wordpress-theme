				...
				<div class="accordion text-start" id="accordionExample">
					<div class="accordion-item mb-3">
						...
						<div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="heading-1"
							...
							<div class="accordion-body">
								<p class="mb-0">Срок производства зависит от материалов и составляет от 20 рабочих дней. Сроки, в
					...
					<div class="accordion-item mb-3">
						...
						<div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="heading-3"
							data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<p class="mb-0">Стоимость выезда замерщика составляет 1500 руб. Но если Вы заключаете договор, то замер
									для Вас обходится бесплатно, а оплаченный Вами выезд вычитается из суммы оплаты.</p>
							</div>
						</div>
					</div>
					<div class="accordion-item mb-3">
					...
					<div class="accordion-item mb-3">
						...
						<div id="collapse-5" class="accordion-collapse collapse" aria-labelledby="heading-5"
							...
							<div class="accordion-body pb-2">
								<p class="mb-0">Наш салон является официальным представителем мебельной фабрики Cucina, которая
									выполняет заказы на всю страну и ближнее зарубежье, а следовательно имеет большие объемы закупки
									материалов и производства, что и удешевляет конечную стоимость продукции.</p>
							</div>
						</div>
					</div>
					<div class="accordion-item mb-3">
